...
import 'package:fitness/Calender_package/color.dart';
import 'package:fitness/Calender_package/datewidget.dart';
import 'package:fitness/Calender_package/style.dart';
...
class DatePicker extends StatefulWidget {
  ...
  DatePicker(
    ...
    this.selectedDayStyle = defaultSelectedDayStyle,
    this.selectedDayColor = Colors.black,
    this.selectedTextColor = Colors.white,
    this.selectionColor = AppColors.defaultSelectionColor,
    this.selectionDateColor = AppColors.defauldDateSelectionColor,
...
class _DatePickerState extends State<DatePicker> {
  ...
  void initState() {
    ...
    this.selectedDayStyle =
        widget.dayTextStyle.copyWith(color: widget.selectedDayColor);
...
//        print("Inside Inactive dates.");
              ...
              return DateWidget(
                ...
                selectionColor:
                    isSelected ? widget.selectionColor : Color(0xff142129),
                selectionDateColor: isSelected
                    ? widget.selectionDateColor
                    : Color(0xffFFFFFF).withOpacity(0.2),
                selectionContainerColor:
                    isSelected ? widget.selectionDateColor : Color(0xff142129),
