...
class GetTrainer extends StatefulWidget {
  const GetTrainer({Key? key}) : super(key: key);

  @override
  State<GetTrainer> createState() => _GetTrainerState();
}

class _GetTrainerState extends State<GetTrainer>
  ...
  Future<String> getData() async {
    ...
    String? bid = await prefs.getString("branch");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Available Trainers - " + (total ?? 0).toString(),
