            ...
            return Container(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      Text('Trainer Name :',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600,color: Colors.black),),
                      Text(' ${bookingData?['trainerName']}',style: TextStyle(fontSize: 16,color: Colors.deepOrange),)
                    ],
                  ),
                  SizedBox(height: 8),
                  Row(
                  ...
                  Row(
                    children: [
                      Text('Booking Date :',style: TextStyle(fontSize: 16,color: Colors.black),),
                  ...
                  Row(
                    children: [
                      Text('Booking Time :',style: TextStyle(fontSize: 16,color: Colors.black),),
