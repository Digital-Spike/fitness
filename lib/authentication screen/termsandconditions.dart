        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 5),
              Text(
                '* Republish material from this Application (including republication on another Application);',
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 13,
                  fontFamily: 'SpaceGrotesk',
              ...
              Text('* Sell, rent or sub-license material from the Application;',
                  textAlign: TextAlign.justify,
                  style: TextStyle(
                    fontSize: 13,
                    fontFamily: 'SpaceGrotesk',
                  )),
              Text('* Show any material from the Application in public;',
                  style: TextStyle(
                    fontSize: 13,
                    fontFamily: 'SpaceGrotesk',
                  )),
              Text(
                  '* Reproduce, duplicate, copy or otherwise exploit material on this Application for a commercial purpose;',
                  textAlign: TextAlign.justify,
                  style: TextStyle(
                    fontSize: 13,
                    fontFamily: 'SpaceGrotesk',
              ...
              Text(
                  '* Edit or otherwise modify any material on the Application; or',
                  textAlign: TextAlign.justify,
                  style: TextStyle(
                    fontSize: 13,
                    fontFamily: 'SpaceGrotesk',
              ...
              SizedBox(height: 5),
              Text(
                'Nothing in this Application disclaimer will exclude or limit any warranty implied by law that it would be unlawful to exclude or limit.',
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 13,
                  fontFamily: 'SpaceGrotesk',
              ...
              SizedBox(height: 5),
              Text(
                'These terms and conditions constitute the entire agreement between you and Fitness Journey in relation to your use of this Application, and supersede all previous agreements in respect of your use of this Application.',
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontSize: 13,
                  fontFamily: 'SpaceGrotesk',
